...
AnimatedSprite::AnimatedSprite(std::string spritesheetPath, float ips, unsigned int startIndex) : m_elapsedTime(ips != 0 ? 1.0f / ips + 1 : 0), m_ips(ips), m_activeSpriteIndex(startIndex - 1)
{
